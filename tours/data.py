'''
Storage for mock-data of project stepik-tours
'''
...
tours = {
    ...
    6: {
        ...
        "departure": "spb",
        "departure_r": "из Санкт-Петербурга",
